...
ActiveRecord::Schema[7.0].define(version: 2025_01_15_095658) do
  ...
  create_table "account_skills", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "skill_id"], name: "index_account_skills_on_account_id_and_skill_id", unique: true
